...
var template = "<!--Copyright (c) Coherent Labs AD. All rights reserved. Licensed under the MIT License. See License.txt in the project root for license information. --><component-slot data-name=\"menu-item\">    <menu-item>First Item</menu-item>    <menu-item>Second Item</menu-item></component-slot>";
...
const BaseComponent = components$3.BaseComponent;
...
const KEYCODES$3 = components$3.KEYCODES;
...
components$3.defineCustomElement('gameface-menu', GamefaceMenu);
components$3.defineCustomElement('menu-item', MenuItem);
...
const KEYCODES$2 = components$2.KEYCODES;
...
components$2.defineCustomElement('gameface-left-menu', GamefaceLeftMenu);
...
const KEYCODES$1 = components$1.KEYCODES;
...
components$1.defineCustomElement('gameface-bottom-menu', GamefaceBottomMenu);
...
export { GamefaceBottomMenu, GamefaceLeftMenu, GamefaceMenu, GamefaceRightMenu };
