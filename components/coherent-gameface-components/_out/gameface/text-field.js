...
var template = "<!--Copyright (c) Coherent Labs AD. All rights reserved. Licensed under the MIT License. See License.txt in the project root for license information. --><div class=\"guic-text-field-container\">    <span class=\"guic-text-field-label\"></span>    <div class=\"guic-text-field-with-controls\">        <input class=\"guic-text-field\" type=\"text\" />        <div class=\"guic-text-field-placeholder guic-hidden\"></div>        <div class=\"guic-search-remove guic-hidden\">            <div class=\"guic-search-remove-right-line\"></div>            <div class=\"guic-search-remove-left-line\"></div>        </div>        <div class=\"guic-number-control guic-hidden\">            <div class=\"guic-number-increase\"></div>            <div class=\"guic-number-decrease\"></div>        </div>    </div></div>";
