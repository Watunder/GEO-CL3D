...
var template = "<!--Copyright (c) Coherent Labs AD. All rights reserved. Licensed under the MIT License. See License.txt in the project root for license information. --><div class=\"guic-tooltip\">    <component-slot data-name=\"message\"></component-slot></div>";
