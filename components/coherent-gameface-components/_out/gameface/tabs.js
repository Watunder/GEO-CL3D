...
var template = "<!--Copyright (c) Coherent Labs AD. All rights reserved. Licensed under the MIT License. See License.txt in the project root for license information. --><div class=\"guic-tabs-wrapper\">    <div class=\"guic-tabs-header\">        <component-slot data-name=\"tab\">            <tab-heading slot=\"tab\">First Tab</tab-heading>            <tab-heading slot=\"tab\">Second Tab</tab-heading>        </component-slot>    </div>    <div class=\"guic-tabs-panel\">        <component-slot data-name=\"panel\">            <tab-panel slot=\"panel\">First Tab Content</tab-panel>            <tab-panel slot=\"panel\">Second Tab Content</tab-panel>        </component-slot>    </div></div>";
...
export { TabHeading, TabPanel, Tabs };
